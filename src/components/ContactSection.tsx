  ...
  return (
    <section id="contact" className="py-20">
      <div className="section-container">
        ...
        <div className="content-card p-6 md:p-8 max-w-3xl mx-auto">
          <div className="space-y-6">
            <div className="flex items-start gap-3">
              <Phone className="text-spice-600 mt-1" size={20} />
              <div>
                <h4 className="font-medium text-masala-900">Phone</h4>
                <p className="text-masala-700">+91 9818327309</p>
                <a 
                  href="https://wa.me/919818327309" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-spice-600 hover:text-spice-700 mt-2 font-medium"
                >
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-masala-700">swadsadhna@gmail.com</p>
              </div>
            </div>
